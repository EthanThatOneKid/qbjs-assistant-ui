...
export const weatherTool = tool({
  ...
  inputSchema: z.object({
    location: z.string().describe('The city and country/state to get weather for'),
  ...
  execute: async ({ location, unit }) => {
    ...
    const weather = locationKey ? mockWeatherData[locationKey as keyof typeof mockWeatherData] : {
      temperature: 20,
